...
export default function Banner(){
    return (
        <>
            <section className="header pb-50 " style={{marginTop:"3rem"}}>
                <div className="container-xxl container-fluid">
                    <div className="flex-row d-flex gap-lg-0 gap-5">
                        <div className="col-lg-6 col-12 my-auto mt-200" >
                            ...
                            <p className="mt-30 mb-0 text-lg color-palette-1">We provide millions of ways <br
                                    className="d-md-block d-none"/> to help players become true winners
                            </p>
                            <div className="grow flex-lg-row gap-4 w-full">
